...
In order to have a specific resource without `list` prop listed on the menu, you have to have to [write your own custom menu](./Theming.html#using-a-custom-menu).
